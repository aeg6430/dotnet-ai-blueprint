...
| Dead Code | 🚫 Delete |
| Large Class, Divergent Change, Shotgun Surgery, Feature Envy, Data Clumps, Switch Statements, Speculative Generality, Middle Man, Message Chains, Temporary Field | 💡 |
